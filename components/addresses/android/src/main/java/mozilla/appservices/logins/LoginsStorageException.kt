...
open class AddressesStorageException(msg: String) : Exception(msg)

/** This indicates that the sync authentication is invalid, likely due to having
 * expired.
 */
class SyncAuthInvalidException(msg: String) : AddressesStorageException(msg)

/**
 * This is thrown if `lock()`/`unlock()` pairs don't match up.
 */
class MismatchedLockException(msg: String) : AddressesStorageException(msg)

/**
 * This is thrown if `update()` is performed with a record whose ID
 * does not exist.
 */
class NoSuchRecordException(msg: String) : AddressesStorageException(msg)

/**
 * This is thrown if `add()` is given a record that has an ID, and
 * that ID does not exist.
 */
class IdCollisionException(msg: String) : AddressesStorageException(msg)
 ...
 */
class InvalidRecordException(msg: String) : AddressesStorageException(msg)
 ...
 */
class InvalidKeyException(msg: String) : AddressesStorageException(msg)

/**
 * This error is emitted if a request to a sync server failed.
 */
class RequestFailedException(msg: String) : AddressesStorageException(msg)

/**
 * This error is emitted if a sync or other operation is interrupted.
 */
class InterruptedException(msg: String) : AddressesStorageException(msg)
