...
/**
 * Raw password data that is stored by the AddressesStorage implementation.
 */
data class ServerPassword(

    /**
     * The unique ID associated with this address.
     *
   ...
   val id: String,
     ...
     * that this address has a formSubmitURL instead.
     */
    val httpRealm: String? = null,

    /**
     * The formSubmitURL (as a string). This may be null in the case that this address has a
     * httpRealm instead.
     */
